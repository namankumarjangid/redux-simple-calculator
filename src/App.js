...
import { mulNumber } from "./actions";
import { divNumber } from "./actions";
...
const App = () => {
  ...
  return (
    <>
      ...
      <div className="main-div">
        <div class="container">
          <h1>Multiplcation/Devison Method</h1>
          <h4>using React and Redux</h4>
          <div class="quantity">
            <a class="quantity__minus" title="Decrement" onClick={() => dispatch(mulNumber())}><span>*</span></a>
            <input name="quantity" type="text" class="quantity__input" value={changeTheNumber} />
            <a class="quantity__plus" title="Increment" onClick={() => dispatch(divNumber())}><span>/</span></a>
          </div>
        </div>
      </div>
    </>
